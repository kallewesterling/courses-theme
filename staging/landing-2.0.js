...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const featuredCourseHeaders = createHeaders("Featured Courses", "A collection of our newest releases and recommended courses to get you started on your security journey.");
    ...
    const featuredLearningPathHeaders = createHeaders("Featured Learning Paths", "Explore our curated learning paths designed to take you from beginner to advanced in various security domains. They also give you a badge when you complete them, which you can add to your LinkedIn profile.");
    ...
    const quickStartHeaders = createHeaders("Chainguard Quick Start", "Get started with Chainguard's secure software supply chain tools. This course covers the basics of using Chainguard Enforce, a tool that helps you ensure your software supply chain is secure and compliant.");
    ...
    const aiCourseHeaders = createHeaders("Artificial Intelligence Security", "Learn how to secure AI systems and applications. Our AI focused courses cover topics like secure AI development, AI threat modeling, and AI risk management.");
